...
| Тексеру | Нәтиже |
|---|---|
| AI модулінің инженерлік тесттері | **42 өтті** |
| Backend | **102 өтті**; statement coverage **90%** |
| Frontend unit/API | **31 өтті** |
| Desktop/mobile браузер сценарийлері | **30 өтті**; имитацияланған HTTP |
| Нақты OpenAI, соңғы толық 15 бақылау | **15/15 өтті**; 87 шақыру, 140.3 с |
...
**Deployed URL:** жариялау аяқталғаннан кейін осы жерде беріледі.
